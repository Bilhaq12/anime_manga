...
interface EpisodeDetailClientProps {
  initialEpisodeDetail: EpisodeDetail
}

export function EpisodeDetailClient({ initialEpisodeDetail }: EpisodeDetailClientProps) {
  const [episodeDetail] = useState<EpisodeDetail>(initialEpisodeDetail)
